...
##### `This report provides old results by April 5, 2020`
...
<table align="center">
  ...
  <tr>
    <td>Figure 1: Cumulative incidence of COVID-19 cases in each of 50 U.S. states (D.C. is also included) as well as projected increase and peak time based on real data (visualization plots cut off on April 12th for clarity).</td>
  </tr>
</table>
...
<table align="center">
  ...
  <tr>
    <td>Figure 5: When the inflection point will come? We consider the distribution of the date on which a state will encounter the peak value of number of new infected.</td>
  </tr>
</table>
...
<table align="center">
  ...
  <tr>
    <td>Figure 8: How far we need to push the quarantine? It may vary from state to state. The x axis indicates the contact rate and the y axis is the final number of infected.</td>
  </tr>
</table>
