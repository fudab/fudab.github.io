...
##### `This report provides results from old simulations`      `Last updated: April 14, 2020`
...
<table align="center">
  ...
  <tr>
    <td>(a) Contact rate $\beta$ in every state.</td>
    <td>(b) Basic reporductive number $R_0$ in every state.</td>
  </tr>
  <tr>
...
<table align="center">
  ...
  <tr>
    <td>Figure 5: When will the inflection point come? We consider the distribution of the date on which a state will encounter the peak value of number of new infected.</td>
  </tr>
</table>
