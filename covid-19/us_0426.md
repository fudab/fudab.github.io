...
<table align="center">
  <tr>
    <th align="center"><img width="600" src="./figures_us/US_SEIR_R_0426.png"></th>
  </tr>
  <tr>
    <td>(a) Number of people infected.</td>
  </tr>
  <tr>
    <td align="center"><img width="600" src="./figures_us/US_SEIR_R_percentage_0426.png"></td>
  </tr>
  <tr>
...
<table align="center">
  <tr>
    ...
    <th><img width="600" src="./figures_us/US_R_value_0426.png"></th>
  </tr>
  <tr>
...
<table align="center">
 ...
 <tr>
    ...
    <td align="center"><img width="300" src="./figures_us/US_R_0426.png"></td>
  </tr>
  <tr>
...
<table align="center">
  ...
  <tr>
    <td align="center"><img width="600" src="./figures_us/US_SEIR_I_percentage_0426.png"></td>
  </tr>
  <tr>
    <td>(b) Percentage of people (I) from the from the SEIR model.</td>
  </tr>
  <tr>
    <td>Figure 6: Flatten the curve under contact rate reductions for different compliance levels of social distancing. In the ﬁgure legend, we show when the outbreak of COVID-19 in each state will peak under different scenarios. Without any strong and effective measure of contact reduction, the peak time in most states will be in April and May but ﬂatten the curve would delay the peak in each state with huge variance.</td>
  </tr>
</table>
...
<table align="center">
  ...
  <tr>
    <td align="center"><img width="600" src="./figures_us/US_contact_rate_R_0426.png"></td>
  </tr>
  <tr>
