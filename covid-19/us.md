...
<table>
  <tr align="center">
    <th rowspan="3"><iframe src="https://fudab.github.io/covid-19/figures_us/US_rose.html" width="470px" height="800px" scrolling="no" frameBorder="0"></iframe></th>
  ...
  <tr>
    <td colspan="2">Figure 1: Summary of the COVID-19 information as of July 14, 2020. For (c), the curve in a panel represents the number of cumulative infected people in the state and the histogram indicates the number of new infected people everyday. The color code in (a) and (c) corresponds to the partisan voting index (PVI) by each state.</td>
  </tr>
</table>
